  ...
  return (
    <div>
      ...
      <div className="about-us">
        <h2>About Us</h2>
        <p>
          Welcome to [Your Website Name], your gateway to unforgettable travel
          experiences!
        </p>
        ...
        <section className="mission">
          <h3>Our Mission</h3>
          <p>
            At [Your Website Name], our mission is to provide an effortless and
        ...
        <section className="get-in-touch">
          <h3>Get in Touch</h3>
          <p>
            Have any questions or need assistance? Contact us at [Contact
